export function SavebitePaymentProcessingScreenScreen() {
  return (
    <>
      <div className="relative flex min-h-screen w-full flex-col overflow-hidden items-center justify-center p-6">
        <div className="absolute inset-0 pointer-events-none z-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-primary/10 via-background-light dark:via-background-dark to-background-light dark:to-background-dark" />
        <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-primary/5 to-transparent dark:from-primary/10 pointer-events-none z-0" />
        <div className="relative z-10 flex flex-col items-center w-full max-w-sm gap-10 -mt-20">
          <div className="relative flex items-center justify-center py-8">
            ...
            <div className="w-24 h-24 rounded-full border-[8px] border-primary/10" />
            <div className="absolute w-24 h-24 rounded-full border-[8px] border-primary border-t-transparent border-r-transparent animate-spin-slow" />
              ...
              <div className="flex justify-between items-center pt-1">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center justify-center h-6 px-1.5 bg-black text-white rounded-[4px] border border-black dark:border-slate-700">
                    <span className="text-[11px] font-bold leading-none tracking-wide">Pay</span>
                  </div>
                  <span className="text-sm font-semibold text-slate-900 dark:text-white">Apple Pay</span>
                </div>
              </div>
            </div>
          </div>
