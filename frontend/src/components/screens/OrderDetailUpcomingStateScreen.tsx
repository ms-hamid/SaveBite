export function OrderDetailUpcomingStateScreen() {
  return (
    <>
      <div>
        <header className="sticky top-0 z-50 bg-surface-light dark:bg-surface-dark border-b border-gray-100 dark:border-gray-800/50 px-4 pt-4 pb-3">
          <div className="flex items-center justify-between h-12">
            <button className="flex items-center justify-center w-10 h-10 -ml-2 rounded-full text-text-main-light dark:text-text-main-dark hover:bg-background-light dark:hover:bg-surface-dark transition-colors">
              <span className="material-symbols-outlined text-2xl">arrow_back</span>
            </button>
            <h2 className="text-lg font-bold text-text-main-light dark:text-text-main-dark tracking-tight">Order Details</h2>
            <div className="w-10" /> 
          </div>
        </header>
        <main className="flex-1 overflow-y-auto pb-24">
          ...
          <div className="px-4 mt-8 pb-8">
            <button className="w-full py-3.5 px-4 rounded-xl border border-red-200 dark:border-red-900/30 text-red-600 dark:text-red-400 font-semibold text-sm hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center justify-center gap-2">
        ...
        <nav className="fixed bottom-0 left-0 w-full bg-surface-light dark:bg-surface-dark border-t border-gray-100 dark:border-gray-800 px-2 pb-6 pt-2 z-40">
          <div className="flex justify-between items-end">
            <a className="flex flex-1 flex-col items-center justify-end gap-1 group" href="#">
              <div className="flex h-8 items-center justify-center text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">
                <span className="material-symbols-outlined text-[24px]">home</span>
              </div>
              <p className="text-[10px] font-medium text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">Home</p>
            </a>
            <a className="flex flex-1 flex-col items-center justify-end gap-1 group" href="#">
              <div className="flex h-8 items-center justify-center text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">
                <span className="material-symbols-outlined text-[24px]">search</span>
              </div>
              <p className="text-[10px] font-medium text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">Search</p>
            </a>
            <a className="flex flex-1 flex-col items-center justify-end gap-1" href="#">
              <div className="flex h-8 w-14 rounded-full bg-primary/20 dark:bg-primary/20 items-center justify-center text-emerald-900 dark:text-primary">
                <span className="material-symbols-outlined text-[24px] font-variation-settings-'FILL'1">receipt_long</span>
              </div>
              <p className="text-[10px] font-bold text-emerald-900 dark:text-primary">Orders</p>
            </a>
            <a className="flex flex-1 flex-col items-center justify-end gap-1 group" href="#">
              <div className="flex h-8 items-center justify-center text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">
                <span className="material-symbols-outlined text-[24px]">bookmark</span>
              </div>
              <p className="text-[10px] font-medium text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">Saved</p>
            </a>
            <a className="flex flex-1 flex-col items-center justify-end gap-1 group" href="#">
              <div className="flex h-8 items-center justify-center text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">
                <span className="material-symbols-outlined text-[24px]">person</span>
              </div>
              <p className="text-[10px] font-medium text-text-sub-light dark:text-text-sub-dark group-hover:text-emerald-700 dark:group-hover:text-primary transition-colors">Profile</p>
            </a>
          </div>
        </nav>
      </div>
