export function SavebiteVirtualAccountPaymentInstructionsScreen() {
  return (
    <>
      <div>
        ...
        <div className="relative mx-auto flex h-full min-h-screen w-full max-w-md flex-col overflow-hidden bg-white dark:bg-slate-900 shadow-xl">
          ...
          <footer className="absolute bottom-0 left-0 w-full border-t border-slate-100 bg-white p-4 pb-8 dark:border-slate-800 dark:bg-slate-900 shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.05)] z-20">
            <div className="flex flex-col gap-3">
              <div className="block">
                <label className="main-cta relative flex w-full cursor-pointer select-none items-center justify-center rounded-lg bg-primary px-6 py-3.5 text-base font-bold text-slate-900 shadow-sm transition-all hover:bg-green-400 hover:shadow-md active:scale-[0.98]" htmlFor="loading-trigger">
                ...
                <a className="mt-3 flex w-full items-center justify-center rounded-lg px-6 py-2 text-sm font-semibold text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-300" href="#cancel-modal">
                  Cancel Order
                </a>
              </div>
            </div>
