            ...
            <form onSubmit={handleSubmitReview} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 text-text-main-light dark:text-text-main-dark placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary resize-none scrollbar-hide"
                  required
                />
              </div>
